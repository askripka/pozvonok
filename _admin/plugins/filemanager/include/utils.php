...
function cyrillic_translit($str) {
    $char_map = array(
        'а' => 'a',
        'б' => 'b',
        'в' => 'v',
...
function fix_path($path, $transliteration) {
    ...
    if($tmp_path != "")
        return $tmp_path.DIRECTORY_SEPARATOR.$str; else
        return $str;
}
