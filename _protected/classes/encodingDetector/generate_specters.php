...
$raw_specter = require __DIR__.'/specters/raw.php';

$encodings = array('utf-8', 'windows-1251', 'koi8-r', 'iso8859-5');
...
foreach ($encodings as $encoding)
{
	...
	file_put_contents(__DIR__.'/specters/'.$encoding.'.php', '<?php return '.var_export($specter, TRUE).';');
}